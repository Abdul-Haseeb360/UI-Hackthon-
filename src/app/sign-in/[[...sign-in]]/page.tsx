...
function signIn() {
    return (
        <div className='flex justify-center my-20 '>
            <div className="flex min-h justify-center">
                {/* Left Section */}
                <div className="relative hidden w-1/2 flex-col justify-between bg-gradient-to-r from-green-400 via-teal-500 to-blue-500
 ...
 py-20  px-12 lg:flex rounded-lg">
                    ...
                    <div className="relative z-10">
                        <div className="mb-6">
                            <h1 className="text-4xl font-bold text-white sm:text-4xl">Nice to see you again</h1>
