  ...
  return (
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
            ...
            <p className="text-gray-500 text-center leading-6 mb-9">Problems trying to resolve the conflict between 
            the two major realms of Classical physics: Newtonian mechanics </p>
            {/* <!--Switch--> */}
            <div className="flex justify-center items-center">
                <label className="min-w-[3.5rem] text-xl relative text-gray-900 mr-4 font-medium">Bill Monthly</label>
                <input type="checkbox" id="basic-with-description" className='relative shrink-0 w-11 h-6 p-0.5 bg-indigo-100 checked:bg-none checked:bg-indigo-100 rounded-full cursor-pointer transition-colors ease-in-out duration-200  focus:border-blue-600  appearance-none 
            ...
            <div className="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-8 lg:space-y-0 lg:items-center">
                ...
                <div className="flex flex-col mx-auto max-w-sm text-gray-900 rounded-2xl bg-indigo-50 transition-all duration-500 hover:bg-indigo-100 ">
                    ...
                    <div className="flex items-center mb-6">
                        <span className="font-manrope mr-2 text-6xl font-semibold text-indigo-600">$9.99</span>
                        <span className="text-xl text-gray-500 ">/ month</span>
                    </div>
                    {/* <!--List--> */}
                 ...
                 <div className="flex flex-col mx-auto max-w-sm text-gray-900 rounded-2xl bg-gray-50 p-6 xl:py-9 xl:px-12 transition-all duration-500 hover:bg-gray-100">
                    ...
                    <div className="flex items-center mb-6">
                        <span className="font-manrope mr-2 text-6xl font-semibold">$19.99</span>
                        <span className="text-xl text-gray-500 ">/ month</span>
                    </div>
                    {/* <!--List--> */}
                    <ul className="mb-12 space-y-6 text-left text-lg text-gray-500">
